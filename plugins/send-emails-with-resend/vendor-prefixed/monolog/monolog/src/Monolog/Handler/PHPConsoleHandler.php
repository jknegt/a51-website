...
namespace ResendWP\Monolog\Handler;

use ResendWP\Monolog\Formatter\LineFormatter;
use ResendWP\Monolog\Formatter\FormatterInterface;
use ResendWP\Monolog\Level;
use ResendWP\Monolog\Utils;
use PhpConsole\Connector;
use PhpConsole\Handler as VendorPhpConsoleHandler;
use PhpConsole\Helper;
use ResendWP\Monolog\LogRecord;
 ...
 *
 *      $logger = new \ResendWP\Monolog\Logger('all', array(new \ResendWP\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private array $options = [
        ...
        'classesPartialsTraceIgnore' => ['ResendWP\\Monolog\\'], // array Hide calls of classes started with...
