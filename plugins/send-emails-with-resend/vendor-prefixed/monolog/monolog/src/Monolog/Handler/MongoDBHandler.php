...
use ResendWP\Monolog\Formatter\MongoDBFormatter;
 ...
 * Usage example:
 *
 *   $log = new \ResendWP\Monolog\Logger('application');
 *   $client = new \MongoDB\Client('mongodb://localhost:27017');
 *   $mongodb = new \ResendWP\Monolog\Handler\MongoDBHandler($client, 'logs', 'prod');
