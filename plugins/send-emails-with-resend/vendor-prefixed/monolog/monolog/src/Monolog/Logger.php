...
namespace ResendWP\Monolog;

use Closure;
use DateTimeZone;
use Fiber;
use ResendWP\Monolog\Handler\HandlerInterface;
use ResendWP\Monolog\Processor\ProcessorInterface;
use ResendWP\Psr\Log\LoggerInterface;
use ResendWP\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @throws \ResendWP\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  value-of<Level::VALUES>|Level $level
