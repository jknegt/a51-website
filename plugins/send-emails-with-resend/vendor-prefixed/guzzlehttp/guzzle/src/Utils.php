...
use ResendWP\GuzzleHttp\Handler\CurlHandler;
use ResendWP\GuzzleHttp\Handler\CurlMultiHandler;
use ResendWP\GuzzleHttp\Handler\Proxy;
use ResendWP\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \ResendWP\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
     ...
     *
     * @return callable(\ResendWP\Psr\Http\Message\RequestInterface, array): Promise\PromiseInterface Returns the best handler for the given system.
     *
