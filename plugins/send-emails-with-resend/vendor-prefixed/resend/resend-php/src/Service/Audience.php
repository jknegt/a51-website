...
class Audience extends Service
{
     ...
     */
    public function get(string $id): \ResendWP\Resend\Audience
    {
     ...
     */
    public function create(array $parameters): \ResendWP\Resend\Audience
    {
     ...
     * @return \ResendWP\Resend\Collection<\ResendWP\Resend\Audience>
     *
     ...
     */
    public function remove(string $id): \ResendWP\Resend\Audience
    {
