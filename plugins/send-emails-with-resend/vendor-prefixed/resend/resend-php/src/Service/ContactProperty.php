...
class ContactProperty extends Service
{
     ...
     */
    public function get(string $id): \ResendWP\Resend\ContactProperty
    {
     ...
     */
    public function create(array $parameters): \ResendWP\Resend\ContactProperty
    {
     ...
     * @return \ResendWP\Resend\Collection<\ResendWP\Resend\ContactProperty>
     *
     ...
     */
    public function update(string $id, array $parameters): \ResendWP\Resend\ContactProperty
    {
     ...
     */
    public function remove(string $id): \ResendWP\Resend\ContactProperty
    {
