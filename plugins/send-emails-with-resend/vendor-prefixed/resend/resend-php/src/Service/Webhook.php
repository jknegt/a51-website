...
use ResendWP\Resend\WebhookSignature;
...
class Webhook extends Service
{
     ...
     */
    public function get(string $id): \ResendWP\Resend\Webhook
    {
     ...
     */
    public function create(array $parameters): \ResendWP\Resend\Webhook
    {
     ...
     * @return \ResendWP\Resend\Collection<\ResendWP\Resend\Webhook>
     *
     ...
     */
    public function update(string $id, array $parameters): \ResendWP\Resend\Webhook
    {
     ...
     */
    public function remove(string $id): \ResendWP\Resend\Webhook
    {
