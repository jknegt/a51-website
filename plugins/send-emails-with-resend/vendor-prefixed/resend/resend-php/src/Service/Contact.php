...
use ResendWP\Resend\Service\Contacts\Segment;
use ResendWP\Resend\Service\Contacts\Topic;
...
class Contact extends Service
{
     ...
     */
    public function get(string $idOrEmail): \ResendWP\Resend\Contact
    {
     ...
     */
    public function create(array $parameters): \ResendWP\Resend\Contact
    {
     ...
     * @return \ResendWP\Resend\Collection<\ResendWP\Resend\Contact>
     *
     ...
     */
    public function update(string $idOrEmail, array $parameters): \ResendWP\Resend\Contact
    {
     ...
     */
    public function remove(string $idOrEmail): \ResendWP\Resend\Contact
    {
