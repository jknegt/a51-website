...
class Batch extends Service
{
     ...
     * @return \ResendWP\Resend\Collection<\ResendWP\Resend\Email>
     *
     * @see https://resend.com/docs/api-reference/emails/send-batch-emails
     */
    public function create(array $parameters, array $options = []): \ResendWP\Resend\Collection
    {
     ...
     * @see https://resend.com/docs/api-reference/emails/send-batch-emails
     */
    public function send(array $parameters, array $options = []): \ResendWP\Resend\Collection
    {
