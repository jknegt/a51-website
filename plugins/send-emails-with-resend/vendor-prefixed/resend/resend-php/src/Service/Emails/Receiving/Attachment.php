...
namespace ResendWP\Resend\Service\Emails\Receiving;
...
class Attachment extends Service
{
     ...
     */
    public function get(string $emailId, string $id): \ResendWP\Resend\Emails\Attachment
    {
     ...
     * @return \ResendWP\Resend\Collection<\ResendWP\Resend\Emails\Attachment>
     *
     * @see https://resend.com/docs/api-reference/attachments/list-received-email-attachments
     */
    public function list(string $emailId, array $options = []): \ResendWP\Resend\Collection
    {
